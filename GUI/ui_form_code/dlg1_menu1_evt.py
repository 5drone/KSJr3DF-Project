...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.WS_Name_editText = QtWidgets.QLineEdit(Dialog)
        self.WS_Name_editText.setGeometry(QtCore.QRect(60, 30, 150, 30))
        self.WS_Name_editText.setObjectName("WS_Name_editText")
        self.Group_List_editText = QtWidgets.QLineEdit(Dialog)
        self.Group_List_editText.setGeometry(QtCore.QRect(10, 80, 150, 30))
        self.Group_List_editText.setObjectName("Group_List_editText")
        self.Group_List_comboBox1 = QtWidgets.QComboBox(Dialog)
        self.Group_List_comboBox1.setEnabled(False)
        self.Group_List_comboBox1.setGeometry(QtCore.QRect(190, 80, 150, 30))
        self.Group_List_comboBox1.setEditable(False)
        self.Group_List_comboBox1.setObjectName("Group_List_comboBox1")
        self.Group_List_comboBox2 = QtWidgets.QComboBox(Dialog)
        self.Group_List_comboBox2.setEnabled(False)
        self.Group_List_comboBox2.setGeometry(QtCore.QRect(370, 80, 150, 30))
        self.Group_List_comboBox2.setEditable(False)
        self.Group_List_comboBox2.setCurrentText("")
        self.Group_List_comboBox2.setObjectName("Group_List_comboBox2")
