...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.Group_List_comboBox = QtWidgets.QComboBox(Dialog)
        self.Group_List_comboBox.setEnabled(False)
        self.Group_List_comboBox.setGeometry(QtCore.QRect(370, 80, 150, 30))
        self.Group_List_comboBox.setEditable(False)
        self.Group_List_comboBox.setCurrentText("")
        self.Group_List_comboBox.setObjectName("Group_List_comboBox")
        self.Group_List_Label = QtWidgets.QLabel(Dialog)
        self.Group_List_Label.setEnabled(True)
        self.Group_List_Label.setGeometry(QtCore.QRect(190, 80, 150, 30))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setItalic(False)
        font.setWeight(50)
        self.Group_List_Label.setFont(font)
        self.Group_List_Label.setAlignment(QtCore.Qt.AlignCenter)
        self.Group_List_Label.setObjectName("Group_List_Label")
        self.Group_delete_pushButton = QtWidgets.QPushButton(Dialog)
        self.Group_delete_pushButton.setGeometry(QtCore.QRect(10, 270, 150, 30))
        self.Group_delete_pushButton.setObjectName("Group_delete_pushButton")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.Group_List_Label.setText(_translate("Dialog", "구성요소 목록"))
        self.Group_delete_pushButton.setText(_translate("Dialog", "그룹 삭제"))
